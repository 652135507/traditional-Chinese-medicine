...
create index NBFHZMXJL_idx0 on NBFHZMXJL(HXJYLSH ,ZJYLSH ,BCXH ,NBFHZZH ,HXJYRQ ,CJRQ );
...
create index XDYWZHDYW_idx0 on XDYWZHDYW(ZHDYWBH ,CJRQ );
create table JJKXX (
...
create index XYKZHJYMXB_idx0 on XYKZHJYMXB(JYJZRQ ,HXJYLSH ,ZJYLSH ,BCXH ,CJRQ );
create table SXXX (
...
create index JYLS_idx0 on JYLS(HXJYLSH ,ZJYLSH ,BCXH ,JYRQ ,JYZH ,CJRQ );
...
create index SNTJB_idx0 on SNTJB(NBJGH ,TJKMBH ,QXLX ,TJRQ ,BZ ,CJRQ );
...
create index LCCPXXB_idx0 on LCCPXXB(HNBSM ,CJRQ );
...
create index LCCPZTB_idx0 on LCCPZTB(HNBSM ,CJRQ );
...
create index KHLCZHXXB_idx0 on KHLCZHXXB(LCZH ,GLHQCKZH ,HNBSM ,CJRQ );
create table LCCPXSMX (
JYH  varchar2(100)   , /*销售合同号*/
HXJYLSH  varchar2(60)  not null  , /*核心交易流水号*/
ZJYLSH  varchar2(30)  not null  , /*子交易流水号*/
BCXH  integer  not null  , /*笔次序号*/
YXJGDM  varchar2(30)   , /*银行机构代码*/
...
YXJGMC  varchar2(200)   , /*银行机构名称*/
MXKMMC  varchar2(300)   , /*明细科目名称*/
LCZH  varchar2(60)   , /*理财账号*/
KHTYBH  varchar2(60)   , /*客户统一编号*/
KHXM  varchar2(100)   , /*客户姓名*/
GLHQCKZH  varchar2(60)   , /*关联活期存款账号*/
LCCPMC  varchar2(200)   , /*理财产品名称*/
HNBSM  varchar2(30)   , /*行内标识码*/
SGSHBZ  varchar2(6)   , /*申购赎回标志*/
BZ  varchar2(3)   , /*币种*/
HXJYRQ  varchar2(8)  not null  , /*交易日期*/
JYJE  decimal(16,2)   , /*交易金额*/
JYFE  decimal(16,2)   , /*交易份额*/
JYFY  decimal(16,2)   , /*交易费用*/
JYQD  varchar2(60)   , /*交易渠道*/
...
create index LCCPXSMX_idx0 on LCCPXSMX(HXJYLSH ,ZJYLSH ,BCXH ,HXJYRQ ,CJRQ );
